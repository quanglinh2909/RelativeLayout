...
public class CardView extends AbstractBorder {
	private Color color;
	...
	public CardView(Color color) {
		this(color, 4, 8, 7);
	}

	public CardView(Color color, int thickness, int radii, int pointerSize) {
	...
	public CardView(Color color, int thickness, int radii, int pointerSize, boolean left) {
